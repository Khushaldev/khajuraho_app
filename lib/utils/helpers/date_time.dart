...
class DateTimeHelper {
  static DateTime? fromTimezone(
    ...
    return DateFormat(pattern).parse(datetime, true).fromTimezone(
          timezone,
          daylight: daylight,
        );
  }
  ...
  static DateTime? toTimezone(
    ...
    return DateFormat(pattern).parse(datetime, true).toTimezone(
          timezone,
          daylight: daylight,
        );
  }
...
extension DateTimeExtension on DateTime {
  ...
  DateTime get resetMillisecond => DateTime(
        year,
        month,
        day,
        hour,
  ...
  DateTime get onlyDate => isUtc //
      ? DateTime.utc(year, month, day)
      : DateTime(year, month, day);

  DateTime get onlyMonth => isUtc //
  ...
  String format({String format = 'yyyy MMM dd, h:mm a'}) => //
  ...
  String get toFullDateTimeString => //
      DateFormat('EEEE, MMMM dd h:mm a').format(this);
